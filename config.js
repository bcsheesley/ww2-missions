var config = {
    ...
    theme: 'light',
    use3dTerrain: false,
    title: 'Travels of a World War Ⅱ Pilot',
    subtitle: 'Accompanied by the journals of',
