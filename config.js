    ...
    chapters: [
        {
            ...
            imageId: '',
            caption: '',
            description: '<p><span class="dropCap">L</span>t. Byron E. Sheesley kept two short journals while serving in the United States Army Air Forces (USAAF) during World War Ⅱ.</p><p>One journal documents his nearly two-week-long journey from Camp Kilmer, New Jersey to a USAAF replacement center in Staffordshire, England via troopship and train in late October and early November, 1944.</p><p>The other summarizes most of the 35 combat missions he flew over enemy targets in Germany as pilot of a B-17 heavy bomber between December 1944 and March 1945. It also describes aspects of his daily life on base and on pass. Sheesley was stationed in Mendlesham, England with the 34th Bomb Group of the "Mighty" 8th Air Force.</p><p>Entries in both journals were written in a consice, matter-of-fact manner. They are noticeably short on commentary. That said, the 22-year-old pilot\'s emotional recounting of a tense inaugeral mission over Berlin portrays the physical, mental, and occupational stress that he must have faced on a routine basis. And by the time he completes his last mission, it\'s hard not to smile as the stress is relieved and he can finally reunite with his fiance, then 19-year-old Mary E. Clark: <blockquote>Happy Day! No more flack, fighters, gas, oxygen or bomb runs to sweat out. Mary, here I come.</blockquote></p><p>This map connects entries in the two journals with the places they describe. <b>Scroll down to read more.</b></p>',
            location: {
